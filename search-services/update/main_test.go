...
// XKCD API calls, and complex initialization. For production code, these would
// typically be tested with integration tests or the functions would be
// refactored to be more testable. This test file provides basic coverage
// for the testable parts of main.go.
